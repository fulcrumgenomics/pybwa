...
class TestBwaMemErrorHandling:
    ...
    def test_align_after_exit_raises(self, test_fa: Path):
...
class TestBwaAlnErrorHandling:
    ...
    def test_align_raw_string_rejected(self, bwa_aln_aligner: BwaAln):
    ...
    def test_align_quality_length_mismatch(self, bwa_aln_aligner: BwaAln):
